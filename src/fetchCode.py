...
def update_codes():
    def get_directory():
        return Path.cwd().parent.joinpath('docs')
    to_csv(TWSE_EQUITIES_URL, get_directory().joinpath('twse_equities.csv'))
    to_csv(TPEX_EQUITIES_URL, get_directory().joinpath('tpex_equities.csv'))
